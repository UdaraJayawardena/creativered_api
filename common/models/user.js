...
var isEmail = require('../../node_modules/isemail');
...
module.exports = function(User) {
  ...
  User.prototype.verify = function(verifyOptions, options, cb) {
    ...
    // var nullname = require('../../templates/verify.ejs');
    var pkName = userModel.definition.idName() || 'id';
    verifyOptions.redirect = EmailConfig.redirect;
    ...
    verifyOptions.host = EmailConfig.host;
    verifyOptions.port = EmailConfig.port;
  ...
  User.on('resetPasswordRequest', function(info) {
    ...
    let send = User.app.models.Email.send({
      to: info.email,
      from: senderAddress,
